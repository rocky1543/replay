...
def save_word_text(he_xin, name_list, info_map, print_type="A5"):
    ...
    二、固有本性：
        ...
        2、龙头：
            ...
            3、形成好位置：
                1、调整充分后的二波首板，N型首版
                2、趋势主升浪：创新高强于自身历史，强于同行，强于板块，强于大盘
                3、逆势大盘，强于大盘
            4、容量核心，换手充分     
    ...
    三、外在条件：
        1、必要条件： 
            1、大盘必须转强，放量向上
            2、板块指数要强于大盘，板块中多个个股走出新高状态
            3、板块中核心个股要强于板块
            4、放量调整后突破新高，有完美的量价配合
            2、情绪最好足够低位，最好是连续大杀几天，杀了再杀之后的低点，和跳绳一样，绳子落地了再参与
            3、情绪转强，和大盘，板块，龙头，大资金共振向上
            4、资金主动，买盘要有强劲的动力，要有压倒性优势
            4、板块氛围好，小弟很多很强
            
        2、加分条件：
            1、消息刺激，新闻发酵，吸引人气，带动情绪
            2、竞价：高标百万封单顶一字，容量核心竞价抢筹
