...
def save_word_text(bu_zhang_long, lian_ban, name_list, info_map, print_type="A5"):
    ...
    *、龙头：
        ...
        *、唯一高标，唯一性自带人气
        *、最后一个高标通常不会死得很惨，中途死的，成为唯一幸存者的预期没有了，直接被抛弃了
        *、跟风，跟谁的风，跟龙头的风，补涨龙他是一个补涨，而且还是龙，也就是他补涨之后能成为龙
        *、龙头就连板最多、封板最强那一只，毫无争议的第一名
        *、确认龙头：1、2板这一波pk之后，连板最高位置仅存1个标的就是明确的第一名
        *、等同法则：
            *、这两个标的谁是龙头 = 这两个标的谁是第一名，如何确认谁是龙头 = 等同于如何确认谁是第一名
            *、补涨 = 资金恐高 + 眼红效应；龙头断板 = 大王驾崩；人气龙头 = 人气第一 
            *、连板龙头 = 连板高度第一；龙头反包 = 人气股首板，人气方向依旧第一，但连板高度没地位
            *、情绪龙头 = 连板最高标（唯一性）+ 足够旺盛的人气
        *、每天该做什么，不该做什么，有条有理，经过长期大量训练，经验就出来了
            *、切换：出现一个很强的新方向，[做首板]
                *、混沌期，冰点期，没有高度期，没有赚钱效应，没有锚定点来做，只能切换，找新方向
            *、补涨：最强方向打出赚钱效应，[做首板]
                *、先判断高标有没有做补涨的意义，如果有，再找他的补涨，高度不代表人气
                *、如果这个高标有没有参与的意义，它的补涨有没有参与的意义
                *、第一条件：板块要大要强，要有人气
                *、第二条件：龙头要高，梯队要完整，要有赚钱效应
            *、补涨龙：一个很强的龙头，有很强的人气，带出了很强的赚钱效应，才有补涨的意义
                *、市场高度很不清晰的时候，就不用去做补涨了，因为人气不能凝聚成激流之水
                *、补涨如果pk输了赶紧跑，因为人气马上就散了，往下都是深渊，要第一时间走
            *、龙头：最强方向，pk出来的最高连板
                *、第四五天，活下来的高标就是市场的新龙头，可以是太子继承，也可以的藩王谋权篡位
                *、龙一代：题材足够强，足够大，人气足够旺；龙二代：你爹足够强；龙三代：你爹足够强
        *、市场四个东西： 
            *、大盘票：随着大盘周期性起起伏伏
            *、连板情绪票：随着连板天梯树，周期性变大变小，起起伏伏
            *、龙头：人气一直在，人气很旺，可以耐心等一等
            *、补涨跟风：一口气上不来，人气直接散了
        *、龙头基石都是人气：
        ...
        *、复盘逻辑：
            *、搞懂解决什么具体问题，影响多少人，影响多少钱，为什么小米值那么多钱吗？
        ...
        *、杂文：
            ...
            *、龙头死后，4，5板是龙头带出来的，1，2板是在退潮的恶劣环境中自己竞争出来的
            *、他你硬，比你强，凭什么他要死，不能停留在寻找弱者思维
        *、方法论：
            *、做首板就是看高做低，看高位最有人气龙头，如果他在高举高打，就龙头abc属性里最有人气的补涨首板
            *、做龙头就是做二板之上最有人气标的
