...
def save_word_text(ti_cai, info_map, print_type="A5"):
    ...
    for key, val in info_map.items():
        ...
        yu_lu_list = [
            ...
            "去弱留强：龙头分歧给机会，羊群仓位立马从小弟切到龙头里，龙头的虹吸效应是小弟死掉的主要原因",
            "这几年一路走来的艰难困苦，有什么值得歌颂的呢",
            "一波高潮后，个股中会有很多获利盘，埋伏盘，套牢盘，筹码很复杂，筹码已经坏掉了，"
            "小弟没力气了，板块没力气了，大哥也走得不流畅了，所以不是所有的二波都是好的，"
            "你要看板块，跟风，龙头的筹码结构是不是夯实的，需要考虑消息面，当下的市场情绪，"
            "人气能不能拉起一个板块大部分个股的筹码",
            "一波挣大钱之后就变得难做了，就该用小仓位去试了，因为这个时候的筹码结构已经变复杂了",
            "特朗普这一路但凡研究过镇委书记，州长这些东西，他就做不了总统，"
