...
*、学会赚小钱，才能够赚大钱，空仓和牟利本质是矛盾的，空仓不是靠忍住，而是条件没形成，看不上
...
*、长短线：
    ...
    *、短线：
        *、有形：图形，量价，容量梯队
        *、无形：人气，情绪反转向上，明天情绪要比今天强，上升途中情绪慢慢加强
*、龙头：
...
*、光神：
    ...
    *、三点共振，转折日B点：
        ...
        *、当日核心板块，随指数同步启动
        *、个股为板块内人气容量核心
    *、20241004只有类似东财这种级别的东西不断出现，好的赚钱效应才能维持下去，所以不用预判以后会不会好
...
*、杂文：
    ...
    *、交易里最折磨人的，从来不是明确的坏，而是这种模糊的不够好
    *、还没稳定之前，客观事实证明你理解的东西都还是错的，所以要少说话，因为说出的话都是错的
    *、一个板块核心人气股涨得猛，代表板块情绪好，核心人气都不行，代表情绪不好
        *、大部分的股票都是随波逐流的，你去看他们也没有什么意义，只有那些有辨识度的股票，
        *、才能够真正的吸引资金，才能够在关键的位置走得比别的股票强，或者比别的股票弱，
        *、这个时候你就知道市场情绪是好是坏，所以这些辨识度个股，其实是整个市场情绪的指示灯
    *、如果条件不收敛，就永远总结不出规律，你关注的颗粒度应该是每一个交易，而不是每个月的盈利
*、方法论：
