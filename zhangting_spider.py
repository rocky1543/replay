...
def save_word_text(ti_cai, info_map, print_type="A5"):
    ...
    for key, val in info_map.items():
        ...
        yu_lu_list = [
            ...
            "慢下来，坚持无减肥，不要犯错，要冷静，看不见强，看不见猛就往上冲，本质就是贪，大部分的预判都是错的，都是胡思乱想",
            ...
            "二波本质是让你看清楚个股有没有地位，有没有辨识度，有没有人气，有没有群众基础，"
            "看清楚后不等于要买，买不买，取决于现在是不是情绪低，板块强不强，小弟强不强，"
            "你真牛逼，到高位之后还有人气，我再看你，你经历的痛苦我都不参与，等你准备星辰大海了，我再来",
            ...
            "只有在放量上攻的市场环境中才有好赚钱效应",

            "什么是看着强，本质弱：退潮期的板，未经考验的连续一字板，成交量很小的板",
