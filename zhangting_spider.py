...
def save_word_text(he_xin, name_list, info_map, print_type="A5"):
    ...
    for key in name_list:
        ...
        yu_lu_list = [
            ...
            "全是重点就是没有重点，其实不需要智慧，只需要做好选择，做好if else，时间节点，题材方向，龙头个股都是如此，"
            "不会就用排除法",
            ...
            "战略思维其实就是矛盾分析法，例子：你想让家庭关系和睦，可以做：1、处理夫妻关系，2、处理孩子关系，3、处理父母关系，4、努力挣钱，这4个方法都是局部矛盾，"
