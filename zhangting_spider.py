...
def save_word_text(bu_zhang_long, lian_ban, name_list, info_map, print_type="A5"):
    ...
    # 核心
    he_xin = """
*、觉悟的最大修为就是学会休息，空仓不是靠忍住，而是条件没形成，是看不上
*、一个简单的高抛低吸游戏而已，为什么玩不赢呢，只有情绪的高低，为什么这么难，是因为你过分的在乎它
*、第一天很重要：
    *、炒的【这段情绪】：风来了，情绪就来了，人就聚集了，买盘就汹涌了，就像一团火，燃烧得很旺，也很快
    *、你要做的是：尽量在情绪开始的时候，第一天参与进去
    *、市场在波动大小之间来回循环，当市场沉淀下来，波动小的时候，尽量找机会，波动大时，风险大，尽量回避
    ...
    *、情绪溢价：赚的是第二天的情绪溢出效应，赚的是情绪转折节点的钱，情绪来了就工作，情绪走了就休息
*、人气 = 社会讨论度 + 资金活跃度
    *、打板只有三种：首板，接力，二波
*、大数定律
...
*、龙头：
    ...
    *、龙头把板块带起来，补涨就可以套利，新东西很强，老东西的合力就会散开，必然倒下
    *、人气是龙头的基石：
...
*、杂文：
    ...
    *、大势：红军革命为百姓争取权利，一呼百应才能农民起义，新中国成立后，其他革命就动不起来了
