...
def save_word_text(bu_zhang_long, lian_ban, name_list, info_map, print_type="A5"):
    ...
    # 核心
    he_xin = """
    *、第一天很重要，优先看高位，再看如果高位退潮不受冲击的方向
        *、先看方向，再看标的是否是人气，龙头，主流
    ...
    *、龙头：
        *、一切形态随着魂而动，人气就是龙的魂，龙的神，一定要删除，简化，简单，直到可以落地
        *、龙头就毫无争议的第一名，唯一性自带人气，是板块的脊梁，龙头拟合板块指数，板块指数拟合情绪
        *、龙头是情绪的载体，高标不一定是龙头，能带动板块和市场情绪的才是真龙头
        *、每出来一个方向，不管他能不能起，都要把他的大哥找出来，然后去拟合板块的指数和情绪
        *、确认谁是龙头 = 确认谁是第一名
        *、找龙头：
            *、就是找和市场某个方向起落最强相关的个股，它拥有板块和梯队，它能带起一帮人，也能带倒一帮人
            *、他的主升退潮几乎拟合该方向的主升退潮，锚定他等于锚定了该方向的指数周期
        *、情绪周期龙：
            *、每个阶段只有一只票，高标要把独苗去掉
            *、它有梯队，身位最高，它上涨有很强的赚钱效应，它倒下有很强的亏损效应，那么当下就是它的周期
            *、和连板情绪拟合的高标，他起落和连板情绪【起落同步】
        *、主线板块龙：
            *、会有一个大龙，支撑板块脊梁，每个小周期一个小龙领涨板块
        ...
        *、指数：
            ...
            *、大盘、个股只有【放量上涨】才是健康的，大盘缩量下跌后，跌不动了，然后放量，出现一个赚钱效应
            *、市场反弹，人气票大概率会被带起来，指数不跌了就大胆干，指数不好，趋势没戏，退潮期不要盲目去做
        ...
        *、杂文：
            *、上涨的第一天大胆弄，第二天小心弄，第三天谨慎弄，下跌的第一天谨慎弄，第二天小心弄，第三天大胆弄
