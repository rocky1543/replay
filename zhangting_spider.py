...
*、最折磨人的从来不是明确的坏，而是不够出众的好，做不好不是行情不行，而是你那颗想再聪明一点的心
*、看情绪大周期，做情绪小周期，没机会时一直在对抗，不要用战术上的勤奋掩盖战略上的懒惰
*、乔布斯：找不到核心的原因，不是你不够聪明，而是品味不行，目标缩量小到不可能失败
*、太想进步，太想做好本身就是一种执念，确定性在绝对强或绝对弱的环境中
*、你现在的问题：每次交易都是冲着盈利去的，而盈利是市场决定的，市场是不可控的，成长不是由一笔交易决定的
*、顺势而为：顺的是涨价之势，顺的是供需紧张之势
*、第一天很重要：
...
*、大数定律
    ...
    *、一样的条件产生一样的概率：
        *、时机：情绪低点，情绪弱转强，情绪开始的第一天低位
        *、主线：大题材，主线清新，有高度，有宽度，子子孙孙很活跃
        *、龙头：最能赚钱，人气最旺，能带动市场情绪，【英伟达，海力士】
        *、二波：连板，横盘，辨识度，人气旺，量价完美
*、外重者内拙
    *、徒弟：师父，以我的资质，开悟需要多久？师父：十年
    *、徒弟：如果我加倍苦修呢？师父：二十年
    *、徒弟：如果我夜以继日，不休不眠呢？师父：那你将永无开悟之日
*、长线不做高位，短线不做低位，短线只看情绪高低，就像海面的波浪，机会在波浪谷底
*、龙头：
