...
*、市场资金潮汐：
    *、资金注入：
        *、水位到达顶峰，进入困难模式，做对了也亏钱，说明市场处于困难模式
        *、这个时候市场再好，封板率再高，向上没有空间，干什么，研究什么都没用
    *、资金流出：
        *、水位到达底部：进入简单模式，做错了也赚钱，说明市场处于简单模式
        *、这个时候市场再差，向下没有空间，只要市场转强，低吸，追涨，打板都很好做
...
目标：
    ...
    *、高位一定要做前排，不然死的时候出不来，只有大跌后和大涨回调后是安全的，一定要删除，简化到可以落地
    ...
    # 方法三：同时设置宽高（保持比例）
    doc.add_picture('./市场资金潮汐.jpg', width=Inches(5))
