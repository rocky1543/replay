...
def save_word_text(he_xin, name_list, info_map, print_type="A5"):
    ...
    *、人气流动规律：
        ...
        *、最强的板块中自上而下
            ...
            *、高潮后开始分歧
                *、二排给机会，就会吸干三排，一排给机会，就会吸干二三排，高位分歧，会切到低位
        ...
        *、越努力越菜
            ...
            *、赚钱的难点不在行情，而在自己，外重者内拙，你若会游泳，你怎么可能会怕水
            *、得了，先落袋，然后等下次机会，卖飞就卖飞
        *、相：
        ...
        *、市场就两个过程：
            ...
            *、总结：
                *、市场就两个过程起和落，起的时候谁最猛，跌的时候谁最扛揍
                    *、整体上升：找最强的，其他当强不强都是垃圾
                    *、整体回落：找最扛跌的，当弱不弱就是牛逼  
        *、趋势：
            *、趋势向上：上升猛烈，下降温和
            *、趋势向下：下降猛烈，上升温和
