...
def save_word_text(ti_cai, info_map, direction_list, cycle_and_action, print_type="A5"):
    ...
    for key, val in info_map.items():
        ...
        yu_lu_list = [
            ...
            "牛市和熊市的区别：牛市的机会多一些，仅此而已，打仗没有什么神秘，打得赢就打，打不赢就走，"
            "抓住你的弱点，跟着你打，你打你的，我打我的，我们的部队，走也走得，打也打得",
            "战略上藐视敌人：胜利来源于压倒性优势，万物皆周期，永远会有机会，不以人的意志为转移",
            "战术上重视敌人：过程是艰难曲折的，要慎重，耐心等待机会，当战略战术确定之后，剩下比的就是知己知彼，"
            "谁更了解局势了",

            "市场不认可的东西，都是垃圾，杂毛垃圾会让你操作变形，跟酱油换命不值得",
            ...
            "成交量放大，原因只有两个，要么是主动买盘变多了，要么是主动卖盘变多了，你想知道是哪个变多了，"
            "看盘面是红的还是绿的就好了",
            "牛不牛有什么关系呢，跟每一个小周期一样，牛市大周期结束，都是那90%的人买单",
            "你需要把很复杂的东西，简化成你能操作的东西，你需要考虑的东西越少越好，现在最牛逼的东西是什么，"
            "用眼睛看就可以了，不用去想",
            ...
            "那还想那么多做什么，想多了浪费脑子",
            "条件成立你才会去买，拿就要分析哪些是主要条件，哪些是次要条件"
        ]
