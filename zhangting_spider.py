...
def save_word_text(he_xin, name_list, info_map, print_type="A5"):
    ...
    for key in name_list:
        ...
        yu_lu_list = [
            ...
            "战略思维例子：你想让家庭关系和睦，方法可能有：1、关心老婆，2、照顾孩子，3、孝顺父母，4、变得富有，这4个方式都是局部矛盾，"
            "如果变富了，其他3个问题顺应也解决了，家庭和睦的目标也实现了，那么变富就是主要矛盾，然后再以变富为全局考虑，实现变富可以："
            "1、锻炼身体，2、努力工作，3、学习技能..，从中再找出关键点，作为主要矛盾，集中精力去做好它"
