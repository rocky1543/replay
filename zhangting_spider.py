...
def save_word_text(ti_cai, info_map, lao_long_gao_du, cycle_and_action, print_type="A5"):
    ...
    for key, val in info_map.items():
        ...
        yu_lu_list = [
            "慢下来，不是风动，不是幡动，是心在动",
            "看盘要找出每个大事件异动上涨的原因",
            "复盘：自上而下：1、大事件 -> 持续性 -> 龙头；2、二波预期",

            "大行情唯唯诺诺的根源是小行情，行情差，错过买点时的大胆",
            "市场没有量，其实就是玩的人少了，为什么你不挣钱：因为好的机会很少，你却出手很多",

            "核心：任何一场博弈，完胜的条件是士气要高涨，要以多胜少，以强胜弱，牛刀杀鸡，狮子打兔子，"
            "要有绝对的，压倒性的优势，如果没有这个条件只能等, 板块连个一字秒板都没有，硬个屁",

            "二波：题材大小，决定龙头高度，题材能持续，龙头就能持续，不由龙头的高度决定",

            "二波：市场是第一大腿，板块是第二大腿，龙头是第三大腿，在市场不是很差的时候，"
            "板块很强，有着绝对的，压倒性的优势，就可以拧着龙头强劲持续的往上走，反之就拧着龙头往下走",

            "二波：一个再有能力的人，其价值都是平台赋予的，行业，板块，大盘环境就是龙头的平台",

            "二波：因为有了逻辑，才会吸引来资金埋伏，做成二波图形，如果后续这个逻辑还很强，"
            "这个二波就有再次起来的预期，如果逻辑市场不认，这个二波图形就是个垃圾，"
