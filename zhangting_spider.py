...
def save_word_text(ti_cai, info_map, direction_list, cycle_and_action, print_type="A5"):
    ...
    for key, val in info_map.items():
        ...
        yu_lu_list = [
            ...
            "预期关系：板块走弱，大哥跟调整，大哥明天预期板非常硬，小弟也能板，"
            "大哥板一般，小弟能涨五六个点，大哥明天歇菜，小弟直接死",

            "复盘：先大后小，自上而下：1、大题材：大新强 -> 持续性 -> 龙头；2、二波预期；"
            "看盘：什么时候，在哪里，能集中优势兵力，一拥而上，形成碾压之势",

            "如果从个股看不出确定性，多看看板块，确定性就有了，看看板块是不是最强的，有没有其他板块在分散兵力，"
            "板块最强的表现：市场唯一，最强最猛，最有人气，能集中优势兵力",
            ...
            "做作业的时候，不会的题就不要做了，因为做了也做不对，把自己会的题做对了，就可以了",
