...
def save_word_text(he_xin, name_list, info_map, print_type="A5"):
    ...
    *、人气 = 社会讨论度 + 资金活跃度
        ...
        *、连续加速后就避开一下，筹码交换的好，再就继续猛干
    *、买点的核心逻辑
        *、低价，钱多，大故事
        *、买在启动期，或是再次启动期，买在初期，成长期，上升期
        *、市场最核心股就一个，一股之下皆是跟风小弟，要把精力放在最核心的那只股身上
        *、买在市场调整后转强，卖在市场一致后滞涨
    *、大数定律
        ...
        *、高概率事件条件：
            *、大杀的极致冰点之后的情绪向上
            *、处于最强板块中，有板块流动性支撑，社会讨论度最高，资金活跃度最强
    ...
    *、人气流动规律：
        ...
        *、总结：
            ...
            *、束水攻沙：
                ...
                *、打造高标，维持高标在高位强势需要大量的资金，一群人，能托举出一个高标就很不错了
            *、高度不一定是龙头，但是人气、辨识度、流动性收敛的地方肯定是龙头
            *、买点：人气被收敛到哪里，那里能不能锁住人气，形成人气支撑
        *、越努力越菜
            *、急于求成，气急攻心，无间地狱，任何你放不下，想不开，静不了，去强求的事，德不配位而已
            *、德不配位，必有灾殃，当你什么都不要的时候，这个局就解了，做到最后，赚钱只是交易的副产品
            *、干这行不需要悟道，不需要天赋，不需要当神仙，一边倒，毫无还手之力，叫大趋势
            *、太想说的事说明你太在乎，越是在意的东西越是搞你
            *、为什么你做不成大事，是因为别人随随便便给你扔一条鱼，你都有可能被拖进水里
            *、活得不使劲，活得慢才是活得好，一个菜再好吃，你吃得急里忙慌的也不行
            *、真正的强大，不是我一定要赢，而是这局我可以不玩
        *、相：
        ...
        *、复盘逻辑：
            ...
            *、你们知道为什么小米值那么多钱吗？是因为智能手机市场值那么多钱
            *、全球都在换智能手机，你从这个角度看，这是多大的市场
            *、中国的企业家之所以能挣到钱：
                1、中国足够大
                2、中国足够穷
                3、市场有多大，人气就有多大，企业就有多大，小器小成，中器中成，大器大成
        *、大哥：
            *、有比你猛的东西在高举高打，你现在起来算什么，跟风吗
            *、你之前再牛逼，现在有比你强的，你依然只能臣服他人脚下
            *、市场都没退，你怎么知道谁能活下来
        *、市场就两个过程：
            *、整体上升：有明确的板块引领板块市场
            ...
            *、整体下降：市场推倒从来：
                *、新方向：
                     *、去看哪个板块主升，推动哪个龙头最强（帝王）
                     *、其他皆为跟风，没有地位（臣子）
                *、老核心：
                     *、只看最抗跌的，当弱不弱就是好东西（帝王）
                     *、其他皆为跟风，没有地位（臣子）
            *、转折：
                *、转折向下：今天的硬板块，明天可能被板块整体回落拉下马
                *、转折向上：今天的烂板块，明天可能被板块整体上升推起来
        *、龙头战法就2个步骤：
            *、这次整体上升能不能做
            *、如果整体上升能做，最强龙头是谁，有没有你的机会
        *、趋势：
            *、趋势向上：上升猛烈，下降温和
            *、趋势向下：下降猛烈，上升温和
            *、整体升：找最强的，其他当强不强都是垃圾
