...
def save_word_text(he_xin, name_list, info_map, print_type="A5"):
    ...
    for key in name_list:
        ...
        yu_lu_list = [
            "大鹏一日同风起，扶摇直上九万里，只拿属于自己的那一份，你可以永久的做下去",
            "市场大哥断板到大杀之前，机会都是你们的，持续杀几天，杀彻底之后，出现新题材盯着前排大胆做",
            "思考时不能加入太多的变量，不然复杂度会变得非常高，脑子就会混沌",
            "向内求，人性无善无恶，向外求，人性有是非、穷富、善恶，人性之上，规律之下",
            "看盘：先大后小，自上而下，在哪里打仗，能不能赢，明天有没有更多的人来",
            "板块大哥都死了，就不要去板块里面玩了，市场大哥都死了，其他大哥也不能活",
            ...
            "全是重点就是没有重点，其实不需要智慧，只需要做好选择，行情不好的时候，不要出手，行情好的时候，猛干核心",
            ...
            "战略上：要从全局考虑，从高低新旧四个纬度，找出关键点在哪里，明确该做什么，不该做什么，永远都会有机会，不以人的意志为转移",
            "战术上：在变化中寻找压倒性优势机会，过程是艰难曲折的，当战略战术确定之后，剩下比的就是谁更了解局势了",

            "市场不认可的东西都是垃圾，如果从个股看不出确定性，多看看板块，确定性就有了",
            "市场最高标退潮影响其他板块高标和它所在板块，板块最高标退潮影响它自己的板块",
            ...
            "开始分歧了，后排都要卖，因为龙头分歧给机会，虹吸效应会把后排跟风吸死，当龙头也断板了，不涨了，"
            ...
            "做最高标：最高标断板的时候，高位情绪就弱了，第1、2天要把高位股全卖了，第2、3天情绪会惯性"
            "从顶部往下杀，第4天之后大部分的中高位都死的差不多了，下杀的情绪释放差不多了，高标可能只剩下"
            "1、2个，目标少了就清晰了，也就是最高标断板，会带着好几个高标跟着它一起死，第4天之后，"
            "等底部情绪好了，底部会反哺，反推高标",
            "老师所有的操作都在告诉你，要买就买那个最独一无二的，最强的，宁可不做也要缩小范围，减少目标",
            "大杀之后，为什么老东西就不行了，因为套牢盘太多，短线资金也要出来",
            "以后只做：1、调整了几天的二波，2、大杀之后的N型首版，3、强得令人发指的、独一无二的龙头，"
            "其他垃圾跟我一毛钱关系都没有，除了龙头以外的二板以上跟我都没关系，引入太多变量，"
            "只会增加复杂度，我很菜，不精明，不自律，挣钱时会失去警惕性，所以需要条件做约束",
