...
def save_word_text(ti_cai, info_map, direction_list, cycle_and_action, print_type="A5"):
    ...
    for key, val in info_map.items():
        ...
        yu_lu_list = [
            ...
            "板块走弱，大哥跟调整，大哥明天预期板非常硬，小弟也能板，"
            "大哥板一般，小弟能涨五六个点，大哥明天歇菜，小弟直接死",
            "一阶段：龙头一波主升，二阶段：龙头同属性或新题材补涨，三阶段：龙头二波",

            "复盘：先大后小，自上而下，看盘：资金在被什么题材吸引，他们集中聚焦在哪里",
            ...
            "做作业的时候，不会的题就不要做了，把自己会的题做对了，就可以了",
