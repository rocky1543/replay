...
*、最折磨人的从来不是明确的坏，而是好得不够出众，做不好不是行情不行，而是你那颗想再聪明一点的心
*、道是高低，龙头、补涨、切换是方向，术是可持续的人气，所有人都是赢家的时候才是好的机会
*、看情绪大周期，做情绪小周期，没机会时一直在对抗，不要用战术上的勤奋掩盖战略上的懒惰
*、乔布斯：找不到核心的原因，不是你不够聪明，而是品味不行，目标缩量小到不可能失败
*、太想进步，太想做好本身就是一种执念，机会来自其他交易者的情绪失控，确定性在绝对强或绝对弱的环境中
*、第一天很重要：
    *、市场在平静波动之间来回循环，退潮的时候才知道谁是好东西，所有买点都回归人气吧
...
*、大数定律
    ...
    *、唯一途径：经过大量的练习，总结经验，知道什么情况下大概率能赚钱，然后耐心去等就行了
    *、一样的条件产生一样的概率：
        *、时机：
            *、要看明天，明天有增量资金，可以持续，盈亏比要好
            *、恐慌，退潮，情绪低点，情绪弱转强，【这段情绪】开始的第一天低位，龙头确认给机会的第一天
        *、主线：大题材，大容量，主线清新，有高度，有宽度，子子孙孙很活跃，所有人都是赢家
        *、龙头：能带动市场情绪，最猛，人气最旺
...
*、长短线：
    ...
    *、长线只做市场极致绝望的低位，短线也一样，情绪极致绝望的时候孕育大龙头
    *、长线只看价格高低，就像一年四季的气温，机会在市场极寒的时候，没有最好的公司，只有最好的价格
    *、短线只看情绪高低，就像海面的波浪，机会在波浪谷底，去做逆势抗争者，做市场明天的弱转强
*、龙头：
    ...
    *、人气是龙头的基石：
        ...
        *、放量上涨 → 缩量回调 → 再放量 主升浪中的健康买点
        *、短线机会 = 情绪冰点 + 板块共振 + 量能确认 + 核心地位
    *、相：
...
情绪周期：
    ...
    *、根据市场强弱的规律去获利
        *、在市场很差且明天有望变好的时候进，市场高潮的时候出，涨潮时不买，退潮时才知道谁是好东西
目标：
