...
def save_word_text(ti_cai, info_map, print_type="A5"):
    ...
    for key, val in info_map.items():
        ...
        yu_lu_list = [
            ...
            "战略思维: 我如果是市场先生，明天我拉哪个板块，哪个个股，能得到市场认同，形成合力，能盘活整个市场",
            ...
            "二波本质是让你看清楚个股有没有地位，辨识度，人气，群众基础，看清楚后不等于要买，"
            "买不买，取决于现在是不是情绪低位，板块强不强，小弟强不强，你真牛逼，到高位之后还有人气，"
            "我再看你，你经历的痛苦我都不参与，等你准备星辰大海了，我再来",
            ...
            "小弟没力气了，板块没力气了，大哥也走得不流畅了，所以能不能买，你要看板块、跟风、龙头的筹码结构"
            "是不是夯实的，需要考虑消息面，当下的市场情绪，人气能不能拉起一个板块大部分个股的筹码",
            "一波挣大钱之后就变得难做了，这个时候的筹码结构已经变复杂了，就该用小仓位去试了",

            "你做股票，这一路但凡研究一下各种小垃圾，你就永远做不到那个最大的龙头，龙头就是人气，人人可参与，是群众基础，是能团结一切能团结的力量",
            "华映科技牛逼吗？在我眼里就是个垃圾，他涨一万个板也是垃圾，常山，海能达，欧菲光，长城，宗申，四川，这些才是大道，龙头说白了就是学会比较",
