...
def save_word_text(ti_cai, info_map, direction_list, cycle_and_action, print_type="A5"):
    ...
    for key, val in info_map.items():
        ...
        yu_lu_list = [
            ...
            "慢下来，坚持无减肥，不要犯错，要冷静，往往你很得意的时候，离祸患就不远了",
            "龙头总是万众瞩目，吸引大量的资金, 一波大行情来，你要做的第一件事就是预判谁是大龙头",

            "牛市和熊市的唯一区别是：牛市的机会多一些，仅此而已，打仗没有什么神秘，"
            "不要乱了自己的节奏，打得赢就打，打不赢就走，抓住你的弱点，跟着你打，你打你的，我打我的",
            "战略上藐视敌人：胜利来源于压倒性优势，万物皆周期，永远会有机会，不以人的意志为转移",
            "战术上重视敌人：过程是艰难曲折的，要慎重，耐心等待压倒性优势机会",

            "驱动力：市场不认可的东西，都是垃圾，杂毛垃圾会让你操作变形，跟酱油换命不值得",
            "市场没有量，其实就是玩的人少了，为什么你不挣钱：因为好的机会很少，你却出手很多",
            "大哥明天预期板非常硬，小弟也能板，大哥板一般，小弟能涨五六个点，大哥明天歇菜，小弟直接死",

            "最强板块：市场唯一，主动独立，最强最猛，最有人气，能集中优势兵力，一拥而上，形成碾压之势",

            "如果从个股看不出确定性，多看看板块，确定性就有了，看看板块是不是最强的，有没有其他板块在分散兵力",
            ...
            "反之局势很差，团战酱油秒躺，大哥也站不住，一个再有能力的龙头，其价值也都是板块，大盘环境赋予的",
            ...
            "如果成交量放大，原因只有两个，要么是主动买盘变多了，"
            "要么是主动卖盘变多了；你想知道是哪个变多了，看盘面是红的还是绿的就好了",
            "牛不牛有什么关系呢，想多了乱了心智，跟每一个小周期一样，牛市大周期结束，都是那90%的人买单",
            "你需要把很复杂的东西，简化再简化，简化成你能操作的东西，你需要考虑的东西越少，才会越来越好，"
            "比如说现在最牛逼的东西是什么，你用眼睛看就可以了，不用去想",

            "开始分歧了，后排股都要卖，最强的龙头在后排都死得差不多的时候，筹码才会松动，"
            "就像作战，各个部队的战士都挡不住了，都死光了，司令部才会沦陷",
        ]
