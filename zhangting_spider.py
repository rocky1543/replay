...
def save_word_text(bu_zhang_long, lian_ban, name_list, info_map, print_type="A5"):
    ...
    # 核心
    he_xin = """
    *、一个简单的高抛低吸游戏而已，为什么玩不赢呢：低位才能吸，弱市弱转强时以下所有东西才能成立
    *、画皮：我现在才明白，我为什么发挥不了降魔者的能力，是因为我一直都带着仇恨
    ...
    *、龙头：
        ...
        *、高度可以拉高低位的溢价空间，低位可以奶高位，市场变好的时候干龙头，因为市场变好了，小弟们会奶他
