...
def save_word_text(ti_cai, info_map, lao_long_gao_du, cycle_and_action, print_type="A5"):
    ...
    for key, val in info_map.items():
        ...
        zhu4 = "1、亏钱永远比赚钱容易，因为市场不好的时候，亏得最惨的一般都是追高的，" \
               ...
               "2、慢下来，不是风动，不是幡动，是心在动\n"
        zhu5 = "3、任何一场博弈，完胜的条件是士气要高涨，要以多胜少，以强胜弱，牛刀杀鸡，狮子打兔子，" \
               "要有绝对的，压倒性的优势，如果没有这个条件只能等, 板块连个一字秒板都没有，硬个屁\n" \
               "4、市场是第一大腿，板块是第二大腿，龙头是第三大腿，在第一大腿不往下拧的时候，" \
               "第二大腿很强，有着绝对的，压倒性的优势，就可以拧着第三大腿强劲持续的往上走\n" \
               "5、一个再有能力的人，其价值都是平台赋予的，龙头的平台就是行业，板块，大盘环境\n" \
               "6、因为有了逻辑，才会吸引来资金埋伏，做成二波图形，如果后续这个逻辑还很强，" \
               "这个二波就有再次起来的预期，如果逻辑市场不认了，这个二波图形就是个垃圾\n" \
               "7、大行情唯唯诺诺的根源是小行情，行情差的大胆\n" \
               "8、环境差：最好的没人抢，丑的有人要吗，环境好：最好的抢不到，只能将就丑的\n" \
               "9、复盘：自上而下：1、大事件 -> 持续性 -> 龙头；2、二波预期\n" \
               "10、看盘要找出每个大事件异动上涨的原因"
