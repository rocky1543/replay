...
def save_word_text(he_xin, name_list, info_map, print_type="A5"):
    ...
    *、人气流动规律：
        ...
        *、越努力越菜
            ...
            *、真正的强大，不是我一定要赢，而是这局我可以不玩，浓墨的地方见真本事，空着的地方见真境界
            *、如果能保本，就一定有机会赚钱，概率的尽头是空仓，耐心等到胜率高的机会才出手，就可以了
            *、外重者内拙，就像谈恋爱一样：
        ...
        *、市场就两个过程：
            *、整体上升：有明确的板块引领板块市场
                ...
                *、其他皆为跟风，没有地位（臣子）
            *、整体下降：市场推倒从来
                *、新方向：去看哪个板块主升，推动哪个龙头最强，其他皆为跟风，没有地位（臣子）
                *、老核心：只看最抗跌的，当弱不弱就是好东西，其他皆为跟风，没有地位（臣子）
            *、转折：
