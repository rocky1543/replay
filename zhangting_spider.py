...
def save_word_text(he_xin, name_list, info_map, print_type="A5"):
    ...
    for key in name_list:
        ...
        yu_lu_list = [
            ...
            "全是重点就是没有重点，其实不需要智慧，只需要做好选择题，做好if else，时间节点，题材方向，龙头个股都是如此，"
            "不会就用排除法，找出主要节点，主要方向，主要个股",
            ...
            "战术上重视敌人：以十当一，在运动中创造压倒性优势，过程是艰难曲折的，耐心等待机会，当战略战术确定之后，剩下比的就是谁更了解局势",
            ...
            "开始分歧了，后排都要卖，因为龙头分歧给机会，龙头虹吸效应会把跟风后排吸死，当龙头也断板了，不涨了，"
            "最漂亮的那个也没人追了，说明买盘力量已经枯竭了，就像楼市，北京房价都跳水了，其他城市肯定惨淡",
            ...
            "战略思维其实就是矛盾分析法，例子：你想让家庭关系和睦，可以做：1、关心老婆，2、照顾孩子，3、孝顺父母，4、努力挣钱，这4个方法都是局部矛盾，"
            "如果变富了，其他3个问题顺应也解决了，家庭和睦的目标也实现了，那么挣钱就是主要矛盾，其他就是次要矛盾，然后再以挣钱为全局考虑，实现变富可以："
            "1、锻炼身体，2、努力工作，3、学习技能..，从中再找出关键点，作为主要矛盾，集中精力去做好它，次要矛盾就暂时忽略"
    ...
    bj = """ 
    主要矛盾：三大范围：时间节点、题材方向、核心强势个股，也就是每天复盘只需要考虑三大范围即可
