...
def save_word_text(he_xin, name_list, info_map, print_type="A5"):
    ...
    交易的核心：
        *、先求势，再求利，事可成
        *、先求利，后求势，事难成
        *、不求做对，只求不做错，不求暴富，只求生存
        *、你拿的标的，是不是在当下最强的方向里，是就格局，不是就不格局
        *、你关注的标的，是不是在当下最强方向里，是就可以看，不是不要考虑
        *、总体方向有这几个
            1、新东西很强
            2、当下题材很强
            3、当下题材见顶，低位很强
            ...
            5、市场普涨，抱团倒下
            6、先找方向，再考虑这个方向能不能起
            7、中位高位弱了，市场进入退潮，高位的高度需要再议
        *、人气 = 社会讨论度 + 资金活跃度
            *、二波前面的连板，是为了看他的人气
            *、知道的人，讨论的人，关注的人，参与交易的人越多，物品越好交易，也就是物品越好流动
            *、流动性越充足，越容易产生狂热交易，越容易产生流动性溢价
            *、激水漂石，龙头就是人气资金流动性最强的地方
    """
