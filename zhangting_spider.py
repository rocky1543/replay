...
def save_word_text(bu_zhang_long, lian_ban, name_list, info_map, print_type="A5"):
    ...
    # 核心
    he_xin = """
    *、一个简单的高抛低吸游戏而已，为什么玩不赢呢：高潮要抛，低位才能吸，低位转强时以下所有东西才能成立
    *、第一天很重要，优先看高位，再看如果高位退潮不受冲击的方向【人气，龙头，主流】
        *、板块主升，托举龙头主升，这才是是正解，风来了，情绪就来了，情绪来了，人就聚集了
        *、社会讨论度决定板块地位，资金活跃度决定龙头地位，板块讨论度带来的资金流动性会把龙头托举起来
    *、人气 = 社会讨论度 + 资金活跃度
        *、二波关键词：连板，横盘，辨识度，人气，主线，方向核心，启动初期，量价完美，位置夹在中间
    ...
    *、龙头：
        *、一切形态随着魂而动，人气就是龙的魂，龙的神，一定要删除，简化到可以落地
        *、确认谁是龙头=确认谁是第一名，唯一性自带人气，是板块的脊梁，龙头拟合板块指数，板块指数拟合情绪
        *、龙头是情绪的载体，高标不一定是龙头，能带动板块和市场情绪的才是真龙头
        *、每出来一个方向，不管他能不能起，都要把他的大哥找出来，然后去拟合板块的指数和情绪
        ...
        *、找龙头：就是找主升退潮和指数&情绪拟合的个股，锚定他等于锚定了该方向的指数周期
        *、情绪周期龙：
            *、每个阶段只有一只票，和连板情绪拟合的高标，他起落和连板情绪【起落同步】，高标要把独苗去掉
            *、它有梯队，身位最高，它上涨有很强的赚钱效应，它倒下有很强的亏损效应，那么当下就是它的周期
        *、主线板块龙：
            *、会有一个大龙，支撑板块脊梁，每个小周期一个小龙领涨板块，还会有左右护法
        ...
        *、指数：
            ...
            *、大盘、个股只有【放量上涨】才是健康的，大盘缩量跌不动了，然后放量，会出现一个赚钱效应
            *、市场反弹，人气票大概率会被带起来，指数不跌了就大胆干，退潮期不要盲目去做
        ...
        *、杂文：
            *、第一天很重要：上涨的第一天大胆弄，第二天小心弄，第三天谨慎弄
                *、第一天转折向下：今天的硬板，明天可能被板块整体回落拉下马
                *、第一天转折向上：今天的烂板，明天可能被板块整体上升推起来
            ...
            *、什么时候能放下，不着急，不求暴利，享受孤独，心态才算成熟
            *、交易是一面镜子，照出你所有的弱点：得意洋洋，沾沾自喜，对亏损的恐惧，对得到的焦急
            *、什么是天道：吃饭的时候吃饭，睡觉的时候睡觉，做交易的时候做交易，而不是患得患失的去搞钱
        *、行情好的时候多做，行情不好的时候少做：之前我认为的行情好，已经是高潮了
            *、行情好：大题材，大主流，大容量，梯队完整，主线清新，有高度，高度有硬度，高位有人气
            *、多做：对的时间做对的事情，在大周期里有节奏的做小周期
        *、方法论：
            *、做首板就是看高做低，即：看高位最有人气龙头做他的属性补涨首板
            *、做龙头就是做二板之上最有人气标的，即：只做第一名，二板以上只做龙头
            *、拳头收回来再打出去才有力气，伸出去一半了，已经卸力了
            *、能持续的逻辑：有曝光，有流量，有社会讨论度，属性不断发散
            *、龙头：强者恒强，只看班级学霸；补涨龙=大题材里，高低切；补涨=大题材里，看高做低
            *、一轮行情的流程：1、龙头上涨；2、龙头补涨；3、题材切换
            *、子子孙孙：只要他的子子孙孙还在活跃，就能超跌低吸，二波打板，子子孙孙死的死，伤的伤，那就结束了
        老师：
            *、复盘看看当天炒什么题材，再看看有没有可能二波的
            *、盘中看看今天炒什么题材，看看有没有【首板】可能二波的
            *、老师主要做的还是二波，找对方向，做二波，图已经做好了，资金已经准备好了，就等方向切过来
        养家对方向的观察：
            *、观察赚钱效应：低吸的，追涨的，打板的，接力的人都赚钱了，也就高潮了
            *、观察亏钱效应：接力的，打板的，追涨的，低吸的，都亏钱了，也就到底了
            *、整个循环：低位的赚钱，慢慢延伸到高位赚钱，然后高位出现亏钱，再回到低位，高低位都亏钱，题材结束
            *、除了补涨是眼红效应，跟风大哥一起涨，补涨龙，切换都是一个自然循环，都是高位到头回到低位
        情绪周期：
            *、核心思想【他带起的情绪】，优先看高位，再看如果高位退潮【不受冲击】的方向
            *、有比你猛的东西在高举高打，有比你强的东西在吸金，你现在起只能算【他情绪周期】下的跟风
            *、深纺织是当前情绪周期龙头，储能再怎么强，也是深纺织的小弟，深纺织退潮，会将【储能队伍】击溃
            *、在大龙头周期内出来的票，跟风也好，独立闯出的新题材也好，在大龙头倒下的时候，退潮强大的亏钱效应
            *、会让这批股溃不成军，幸存下来的独苗，没有梯队支撑，也不会有什么大作为，好的题材都是上下相互反哺
            *、其他高位都死完了，止跌了，杀高结束了它还在高位，就是牛逼
        目标：
