...
def save_word_text(he_xin, name_list, info_map, print_type="A5"):
    ...
    for key in name_list:
        ...
        yu_lu_list = [
            ...
            "这并不是我生活的主要",
            "你看这火是不是很旺，但过一会它就过去了，美好成为美好的时候，它已经慢慢消亡了，"
            "像这火烧得很旺的时候已经在慢慢燃尽",
            "看盘：先大后小，自上而下，关注主要，忽略次要，人性之上，规律之下，三大原则：大主流，大未来，大容量，"
            "博弈大忌：贪图对手的小利",
            "龙头就是去理解那个砸不死的合力，如果砸死了，证明买的票是垃圾，割肉就好了",
            "赚钱的本质一定是低买高卖：1、情绪低点，足够低位，2、向上有足够强的动力",
            "事情本身是很简单的，但由于涉及利益，恐惧贪婪，患得患失会使人心里变形，做决策不理智，"
            "从矛盾对立统一的角度看，输赢本是一体，输得起才能赢得起，只拿属于自己的那一份，你可以永久的做下去",
            "思考时不能加入太多的变量，不然复杂度会变得非常高，脑子就会混沌",
            "市场没有量，其实就是玩的人少了，小行情，行情差，大杀前错过买点时的大胆，是你亏钱的根源",
            ...
            "如果你在顶层做了正确的事，底层结果就不会差，要做将军就不要去关注小卡了咪的细节",
            "为什么有的人越努力越焦虑？因为他们只看到了努力，却忽视了规律，就像老百姓种地，再着急也要遵循春种秋收"
            "的自然法则，规律是在一定条件下必然发生的事情，目前主要矛盾是解决心理问题",
            ...
            "",
            "抓住主要：",
            "贪多是得不到的，要给自己定清晰的界限，当下时机，当下板块，当下个股该不该看，不该看的，一律不看",
            ...
            "自我约束：1、调整了几天的二波首板，2、大杀之后的N型首版，3、强得令人发指的、独一无二的龙头，"
            "其他垃圾跟我一毛钱关系都没有",
            "怎么判断题材有没有结束：龙头核心A杀，当下属于退潮阶段，龙头人气没散，板块指数量能很足，题材炒作就没结束，"
            "板块小弟很活跃，龙头核心就不会差",
            "老师说只是老师说，跟真理说不一样，真理是一直在运动，发展，变化的",
    ...
    一、时间节点：涨潮， 退潮，随着时间的变化，买卖强弱关系是会相互转化的，即阴阳循环，祸兮福所倚，福兮祸所伏
    ...
    五、规律：事物本性如此，在条件充分的情况下可以稳定，重复发生的事，如果事物没有那种本性，无论提供什么条件，都不会产生相应的变化。
    ...
    条件：
        1、充要条件：集中力量认真做
            1、赚钱的本质一定是低买高卖，所以情绪需要在低点，足够低位，最好是连续大杀，杀了再杀之后的低点
            2、买点一定是情绪转强向上的时候，大盘，板块，龙头共振向上，要有压倒性优势，足够强的动力
            
        2、必要条件：持续做 
            1、大盘没有系统性风险：最好是放量上涨，次之稳住不跌
            
        3、充分条件：尽量少做
        4、空无条件：坚决不做
            1、龙头断板，连板天梯中的高位股撑不住，高位整体向下杀，机会一律放弃
            2、大盘暴跌会带崩情绪，要学会放弃
    ...
    万能公式：           
        ...
        本性：本身固有的性质
            ...
            2、阴性质：规定事物的未来，隐藏在体内，想显露出来需要外在条件刺激，例如纸可燃
        条件：
            1、充要条件
            2、充分条件
            3、必要条件   
