...
def save_word_text(he_xin, name_list, info_map, print_type="A5"):
    ...
    for key in name_list:
        ...
        yu_lu_list = [
            ...
            "这并不是我生活的主要",
            "看盘：先大后小，自上而下，关注主要，忽略次要，人性之上，规律之下，心不死，道不生",
            "龙头就是去理解那个砸不死的合力，如果砸死了，证明买的票是垃圾，割肉就好了",
            "赚钱的本质一定是低买高卖：1、情绪低点，足够低位，2、向上有足够的动力",
            ...
            "市场没有量，其实就是玩的人少了，为什么你不挣钱：因为好的机会很少，你却出手很多，小行情，行情差，"
            "大杀前错过买点时的大胆，是你亏钱的根源",
            "反者道之动，在市场极其弱的时候，情绪转强可能很快就到来，这时去找和大盘，板块共振向上的最强个股，"
            "你为什么做不好，因为符合条件的机会是极其少，你却又有一颗无限想操作的心",
            "基本规律：1、涨多了会跌，跌多了会涨，涨得越多，跌得越多，2、大杀之后，经过充分调整的位置才算安全，"
            "3、急没有用，反而会产生反作用",
            "如果你在顶层做了正确的事，结果就不会差，要做将军就不要去关无关紧要的细节",
            "为什么有的人越努力越焦虑？因为他们只看到了努力，却忽视了规律，就像老百姓种地，再着急也要遵循春种秋收的自然法则",
