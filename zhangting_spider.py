...
def save_word_text(he_xin, name_list, info_map, print_type="A5"):
    ...
    for key in name_list:
        ...
        yu_lu_list = [
            ...
            "博弈大忌：贪图对手的小利",
            "龙头就是去理解那个砸不死的合力，充分条件时产生的砸不死的合力，如果砸死了，证明买的票是垃圾，割肉就好了",
            "赚钱的本质一定是低买高卖：1、情绪低点，足够低位，2、向上有足够强的动力",
            "事情本身是很简单的，但由于涉及利益，恐惧贪婪，患得患失会使人心里变形，做决策不理智，从矛盾对立统一的角度看，"
            "输赢本是一体，只有放下赢的喜悦，才能放下输的痛苦，只拿属于自己的那一份，你可以永久的做下去",
    ...
    五、规律：事物存在某种本性，且条件充分的情况下可以稳定，重复发生的事，如果事物没有那种本性，无论提供什么条件，都不会产生相应的变化。
    ...
    条件：
        ...
        2、必要条件：持续做 
            ...
            2、赚钱的本质一定是低买高卖，所以情绪需要在低点，足够低位，最好是连续几天大杀，杀了再杀之后的低点
