...
def save_word_text(print_type="A5"):
    ...
    # 添加标题，0表示样式为title
    yu_lu_list = [
        "花时间越多，会的越多，出手越多，越不赚钱",
        "内因 + 外在条件, 量价关系是内因，外在条件就是板块整体",
        "龙头，高标，人气股想涨得好，需要小弟们托举，所以整体环境不能太差，小弟在跌不动的时候，才不会太差，"
        "所以你等的时机是什么：是小弟，底部，辅助们跌不动的时候，开始变强的时候，反过来，"
        "如果底部，辅助们不行的时候，高标也会不行，这个时候就是情绪的高点了，所以看盘看什么，先看小弟们的表现",
        "大盘单边向上，说明市场氛围好，也就是很多板块好，这样主线也不会差，主线板块不差，主线龙头也不会差",
        "当大盘单边向上，说明大势氛围好，主线ABC，AB可能见顶向下，C向上，C就满足大盘，题材共振，C就是好的主线",
        "大盘，主流题材大周期，情绪小周期，龙头四者共振",
        "题材末期：1、持续了一个多月，2、核心人气已经经历了二波，3、补涨等逻辑弱的高潮，人气核心涨不动，基本就完了，"
        "每一波都需要一个人气核心带领，当所有的人气核心都带不动了，只能结束了",
        "高位震荡，如果情绪不好，放不出量，它一定支撑不住，它一定会下来",
        "顺大盘指数，顺题材指数共振主升的标的",
        "考试A60分，B80分，C98分，D99分，E100分，还有很多100分，他们的性质是不一样的",
        "要在阳气最盛的时候找机会：1、极阴为阳，2、初升为阳",
        "在情绪反转点，大盘，主线大周期，短线情绪小周期，情绪向上的时候，去搞一个共振的标的",
        "看太多就会产生太多的念，从而导致你的行为杂乱无章",
