...
def save_word_text(print_type="A5"):
    ...
    # 添加标题，0表示样式为title
    yu_lu_list = [
        "要么做绝对的高位，要么做绝对的低位，点带面，面带点",
        "纯做龙头，复盘看盘你就看高标就行，高标只能活一个，除非有一个太强，买不到",
        "龙头就是特别强的个股，贯穿整个题材行情炒作，板块指数跟着它走，也就是它带着板块其他个股在有",
        "模式不应该是打板，而是去找人气第一名，有中心思想的总结规律",
        "做最高标的条件：1、上一个龙头断板第4天之后，2、上一个高标一定要足够高，或者很久没高度了，有个新东西突破高度压制，3、题材大，小弟要硬，4、满足龙头的条件，"
        "注：1~3天，赌它是龙头，风险大，不建议做，第4，5天，确定它是龙头，放心做，之后等龙头断板，退潮，从头再来",
        "核心研究的问题：这情绪还能不能延续",
        "放龙头断板大分歧耗尽力量，跌停退潮宣布死掉，退潮了4天，市场底部开始变好，满足了市场共振的条件，这个时候出现一个大题材，"
        "满足了题材共振的条件，其次再去找满足龙头的条件，然后硬怼，此时的龙头，大概率是新题材的最高标，"
        "因为老周期的标的大部分都在调整，缺少题材共振的条件，龙头确认的那天，就是新周期开始的第一天，经历1234天之后，"
        "大概率龙头断板，然后经历1234天之后，又开始一个新周期",
        "龙头和他脚下的小弟倒下的时候，会不会产生巨大的振动，新东西想活，就看它能不能顶得住龙头死的退潮考验",
        ...
        "到高位之后还有人气，我再看你，厉害的股票肯定有二波，大鹏展翅，肯定要两个翅膀，第一个翅膀就是行情的第一波，"
        "咱们不管他，咱们就盯着第二个翅膀的出现，盯着可能有二波的个股，在从其中找规律，不断的练，不断的亏钱，"
        "信心一点点的被打碎，又一点点的捡起来",
